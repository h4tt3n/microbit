...
def motor_reverse(pin1, pin2, speed):
    if(speed > 0):
        pin1.write_digital(0)
    ...
    if message:
        try:
            ...
            if(a_str == "True"):
                ...
                motor_forward(MOTOR1_PIN1, MOTOR1_PIN2, motor1_speed)
                motor_forward(MOTOR2_PIN1, MOTOR2_PIN2, motor2_speed)
            ...
            if(b_str == "True"):
                ...
                motor_reverse(MOTOR1_PIN1, MOTOR1_PIN2, motor1_speed)
                motor_reverse(MOTOR2_PIN1, MOTOR2_PIN2, motor2_speed)

                print("reverse", motor1_speed, motor2_speed)

            elif(a_str == "False" and b_str == "False"):
                motor_forward(MOTOR1_PIN1, MOTOR1_PIN2, 0)
                motor_forward(MOTOR2_PIN1, MOTOR2_PIN2, 0)
